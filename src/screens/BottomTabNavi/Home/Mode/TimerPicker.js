...
import { mode_ScheduleTimer } from '../../../../redux/actions/Mode/mode_ScheduleTimer';
...
const TimerScreen = ({ navigation, route, getDetails }) => {
...
TimerScreen.propTypes = {
    scheduleTime: PropTypes.func,
    time_schedule_mode: PropTypes.instanceOf(Array),
};
...
const mapStateToProps = ({ setTimeSchdeule: { time_schedule_mode } }) => ({ time_schedule_mode });
const mapDispatchToProps = { getDetails: send => flatDetails(send), scheduleTime: send => mode_ScheduleTimer(send) };
