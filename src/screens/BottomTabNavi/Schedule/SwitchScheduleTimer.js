...
const SwitchSceduleTimer = ({ navigation, route, getDetails }) => {
    ...
    // console.log('route details', route, 'getdetails', getDetails);
    // console.log("displaying routes.params.array", route.params.id);
    ...
    console.log("routes data", route.params.id);
    ...
    const toggle = (index) => {
        const newData = [...days];
        console.log("days destructuring", newData);
    ...
    const apiCall = () => {
        const send = [];
        // console.log("pay load to data", payloadTo);
        // console.log("pay load from data", payloadFrom);
        ...
        send.push(data);
        console.log('data to payload', JSON.stringify(send));
        console.log('log menu api');
        console.log(JSON.stringify(send), 'JSON data stringify in Add TimerSetting');
...
SwitchSceduleTimer.propTypes = {
    getDetails: PropTypes.func,
    modify_schedule_time: PropTypes.instanceOf(Array),
};

SwitchSceduleTimer.defaultProps = {
    getDetails: () => { },
...
// const SwitchSceduleTimer = (navigation, route) => {
...
// export default SwitchSceduleTimer;